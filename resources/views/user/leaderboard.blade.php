...
@section('content')
    <div
class= "relative flex flex-col h-full w-full items-center justify-between gap-5 bg-gray-900 text-white">
...
class= "relative flex flex-col h-full w-full items-center justify-between gap-5 bg-gray-900 text-white">
        ...
        <div class="my-3 relative overflow-x-auto shadow-md sm:rounded-md">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <caption class="text-xs text-gray-700 uppercase bg-gray-50 font-bold text-left px-6 py-1">Novice</caption>
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3">
                            Rank
...
class= "relative flex flex-col h-full w-full items-center justify-between gap-5 bg-gray-900 text-white">
        ...
        <div class="my-3 relative overflow-x-auto shadow-md sm:rounded-md">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <caption class="text-xs text-gray-700 uppercase bg-gray-50 font-bold text-left px-6 py-1">Intermediate</caption>
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3">
                            Rank
...
class= "relative flex flex-col h-full w-full items-center justify-between gap-5 bg-gray-900 text-white">
        ...
        <div class="my-3 relative overflow-x-auto shadow-md sm:rounded-md">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <caption class="text-xs text-gray-700 uppercase bg-gray-50 font-bold text-left px-6 py-1">Advance</caption>
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3">
                            Rank
...
class= "relative flex flex-col h-full w-full items-center justify-between gap-5 bg-gray-900 text-white">
        ...
        <div class="my-3 relative overflow-x-auto shadow-md sm:rounded-md">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <caption class="text-xs text-gray-700 uppercase bg-gray-50 font-bold text-left px-6 py-1">Expert</caption>
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3">
                            Rank
