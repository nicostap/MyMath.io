...
@section('content')
    <div class="flex h-screen w-full flex-col justify-start px-6 py-12 bg-primary relative">

        <div class="relative z-10 mt-10 sm:mx-auto sm:w-full sm:max-w-5xl">
            <div class="text-quinary text-left">
                ...
                <div id="profile-view" class="space-y-8">
                    ...
                    <button onclick="toggleEdit(true)"
                        class="mt-8 flex w-full justify-center rounded-md bg-quaternary px-5 py-3 text-lg font-semibold leading-7 text-white shadow-sm hover:bg-tertiary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-quaternary">
                        Edit Profile
                    </button>
                </div>
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <div class="mt-2 flex items-center">
                            <input id="name" name="name" type="text" value="{{ $user->name }}" disabled required
                                class="input-field flex-1 block w-full rounded-md border-0 py-2 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-300 disabled:text-gray-300 focus:ring-2 focus:ring-inset focus:ring-quaternary sm:text-lg sm:leading-6">
                            <button type="button" onclick="toggleField('name')"
                                class="ml-2 px-4 py-2 text-lg bg-quaternary text-white rounded hover:bg-tertiary focus:outline-none">
                                Edit
                            </button>
                        </div>
