...
<div class="bg-primary">
    <div class="relative px-6 pt-5 lg:px-8 h-screen flex flex-col align-middle justify-center">
        ...
        <div class="grid lg:grid-cols-[15%,35%,35%,15%] mx-auto max-w-screen">
            <div></div>
            ...
            <div class="items-center justify-center hidden lg:flex">
                <img src="{{ asset('M.png') }}"
                    class="w-1/2 rounded-2xl animate-bounce mask mask-image bg-quaternary" />
            </div>
            <div></div>
        </div>
        <div class="text-center mx-auto max-w-screen mt-5 mb-10">
            <div class="sm:mb-3 sm:flex sm:justify-center mt-5">
                <div
                    class="relative rounded-full px-3 py-3 text-sm text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            ...
            <div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
                ...
                <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                    ...
                    <div class="flex flex-1 items-center [container-type:inline-size] max-lg:py-6 lg:pb-2">
                        <img class="h-[min(152px,40cqw)] object-cover" src="{{ asset('SS_ResultGame.jpg') }}" alt="">
                    </div>
                </div>
